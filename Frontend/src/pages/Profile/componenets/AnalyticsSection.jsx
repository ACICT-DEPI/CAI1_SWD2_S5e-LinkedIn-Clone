...
function AnalyticsSection({isOwnProfile}) {
  ...
  return (
    isOwnProfile &&(
       <div className='bg-white rounded-lg mt-3  w-[95%] md:w-[68%] mx-auto pt-5'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 m-5 px-5 mb-5'>
        <div className='flex gap-2'>
          ...
          <div>
              <h3 class="text-base font-semibold md:block text-linkedinDarkGray">0 profile views</h3>
        ...
        <div className='flex gap-2'>
          ...
          <div>
              <h3 class="text-base font-semibold md:block text-linkedinDarkGray">0 post impressions</h3>
